...
private const val PREF_KEY_CACHED_URL : String = "cached_url"
...
class DownloadMetadata(context:Context) {
    ...
    fun getDownloadUrl() : String? {
        return sharedPreferences.getString(PREF_KEY_CACHED_URL, null)
    }

    fun setDownloadUrl(url:String) {
        sharedPreferences.edit().putString(PREF_KEY_CACHED_URL, url).apply()
    }
}
